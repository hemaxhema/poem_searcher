...
class AppTheme {
  ...
  /// Current day/night choice, defaulting to following the OS setting until
  /// the user taps the AppBar toggle (persisted via ThemeModePrefs).
  ...
  static final ThemeData day = _build(
    ...
    background: const Color.fromARGB(255, 225, 239, 249),
